...
local IADSRadioDetection = 1 -- 1 = radio detection of ARM launch on, 0 = radio detection of ARM launch off
...
local EWRAssociationRange = 100000 --Range of an EWR in which SAMs are controlled
local IADSARMHideRangeRadio = 80000 --Range within which ARM launches are detected via radio
local IADSARMHidePctage = 60 -- %age chance of radio detection of ARM launch causing SAM shutdown
local EWRARMShutdownChance = 25 -- %age chance EWR detection of ARM causing SAM shutdown
local SAMARMShutdownChance = 35-- %age chance SAM detection of ARM causings SAM shuttown
