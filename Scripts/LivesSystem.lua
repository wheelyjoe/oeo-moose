...
function LivesEventHandler:onEvent(event)
	...
	elseif (event.initiator and event.id == 4 and event.place:getTypeName() == "Al Minhad AB" and event.initiator:getPlayerName() ~= nil) or (event.initiator and event.id == 4 and event.place:getTypeName() == "Al Dhafra AB" and event.initiator:getPlayerName() ~= nil) 
		or (event.initiator and event.id == 4 and event.place:getTypeName() == "Stennis - airbase" and event.initiator:getPlayerName() ~= nil) or (event.initiator and event.id == 4 and event.place:getTypeName() == "LHA_Tarawa - airbase" and event.initiator:getPlayerName() ~= nil) 
		or (event.initiator and event.id == 4 and event.place:getTypeName() == "CVN_73 - airbase" and event.initiator:getPlayerName() ~= nil)
		then 
